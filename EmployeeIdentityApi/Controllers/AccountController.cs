...
using EmployeeIdentityApi.Providers;
using EmployeeIdentityApi.Results;
...
namespace EmployeeIdentityApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // GET api/Account/GetExternalLogins?returnUrl=%2F&generateState=true
        [AllowAnonymous]
        ...
        public IEnumerable<ExternalLoginViewModel> GetExternalLogins(string returnUrl, bool generateState = false)
        {
            ...
            foreach (AuthenticationDescription description in descriptions)
            {
                ExternalLoginViewModel login = new ExternalLoginViewModel
                {
                    ...
                    Url = Url.Route("GetExternalLogin", new
                    {
